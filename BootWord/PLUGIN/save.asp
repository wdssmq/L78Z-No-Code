...
objUpload.savepath=BlogPath & "zb_users\theme\BootWord\include\"
...
For Each s In objUpload.FormItem
	If Left(s,7)="include" Then
		Call SaveToFile(BlogPath & "zb_users/theme/BootWord/include/" & Right(s,Len(s)-8),objUpload.Form(s),"utf-8",False)
	End If
Next
Dim m
